...
class FileExplorer:
    ...
    def open_file_properties(self, file_name: str) -> Self:
        for _ in range(3):
            ...
            try:
                ...
                continue
        raise PlaywrightTimeoutError(f'Could not open properties for file {file_name}.')
    ...
    def wait_for_upload_completion(self, names: list[str]) -> Self:
        return self.wait_for_action_completion('Uploaded', names)
    ...
    def get_file_tags(self, file_name: str) -> list[str]:
        self.open_file_properties(file_name)
    ...
    def wait_until_uploaded(self, names: list[str]) -> Generator[None]:
        ...
        self.wait_for_upload_completion(names)
        self.close_file_status_popover()
